      ...
      <div class="sub-categories">
        <div class="sub-categories__list">
          ...
          <ul>
            ...
            >
              <svg class="list-circle" height="16" width="16"
                   :class="{'list-circle-active' : seed.value === currentCategory}">
        ...
        <div class="sub-categories__blocks">
          ...
          <div v-if="subCategories.length === 0" class="sub-categories">Вибачте, товарів данної категорії немає у
            наявності<br>
...
export default {
  ...
  computed: {
    ...mapGetters('categories', ['getCategories', 'getFilteredSubCategoryList', 'getCurrentCategory']),
    categoriesItems() {
      return this.getCategories
    },
    subCategories() {
      return this.getFilteredSubCategoryList
    },
    currentCategory() {
